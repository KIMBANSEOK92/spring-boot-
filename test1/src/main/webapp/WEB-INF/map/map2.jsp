<%@ page language="java" contentType="text/html; charset=UTF-8" pageEncoding="UTF-8" %>
    ...
    <head>
        ...
        <script type="text/javascript"
            src="//dapi.kakao.com/v2/maps/sdk.js?appkey=362ba5f7a4612fbcee8923660d44b7a0&libraries=services"></script>
    ...
    <body>
        <div id="app">
            ...
            <select v-model="category" @change="fnSearch" style="margin-bottom : 10px; padding:5px margin-top 10px">
