                ...
                <nav>
                    <ul>
                        <li v-for="item in menuList" class="dropdown">
                            <a href="#" v-if="item.depth == 1"
                                @click="fnList(item.menuNo,'') == 'all'">{{item.menuName}}</a>
                            <ul class="dropdown-menu" v-if="item.cnt > 0">
                                <span v-for="subitem in menuList">
                                    <li v-if="item.menuNo == subitem.menuPart"><a href="#"
                                            @click="fnList('', subitem.menuNo)">{{subitem.menuName}}</a></li>
                                </span>
                            </ul>
                        </li>
                    </ul>
